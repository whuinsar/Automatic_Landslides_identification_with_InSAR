...
def main(parser_data):
    ...
    if os.path.exists(data_root) is False:
        raise FileNotFoundError("Landslide dataset dose not in path:'{}'.".format(data_root))
    ...
    val_dataset = DataSet(data_root, data_transform["val"], "val.txt")
    ...
    io.savemat('pre_recall' + '.mat', {'precision': coco_eval.eval['precision'], 'recall': coco_eval.eval['recall'], 'scores': coco_eval.eval['scores']})
...
if __name__ == "__main__":
    ...
    # 数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='Data_set/Landslide_InSAR_image/', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights', default='./weight_files/best-model.pth', type=str, help='training weights')
