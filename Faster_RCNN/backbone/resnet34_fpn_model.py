...
class ResNet(nn.Module):
    ...
    def __init__(self, block, blocks_num, num_classes=1000, include_top=True, norm_layer=None):
        ...
        self.layer1_ca = ChannelAttention(64)  # 256 res50
        self.layer1_sa = SpatialAttention()

        self.layer2 = self._make_layer(block, 128, blocks_num[1], stride=2)
        self.layer2_ca = ChannelAttention(128)  # 512 res50
        self.layer2_sa = SpatialAttention()
